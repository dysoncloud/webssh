  ...
  function validate_form_data(data) {
    ...
    var hostname = data.get("hostname"),
      ...
      if (!hostname) {
        ...
        document.getElementById('error-hostname').querySelector('span').innerText = "Value of hostname is required.";
        document.getElementById('error-hostname').querySelector('span').style.color = 'red';
      } else {
        if (!hostname_tester.test(hostname)) {
          errors.push("Invalid hostname: " + hostname);
          document.getElementById('error-hostname').querySelector('span').innerText = "Invalid hostname: " + hostname;
          document.getElementById('error-hostname').querySelector('span').style.color = 'red';
        } else {
          document.getElementById('error-hostname').querySelector('span').innerText = '';
        }
      }      
    ...
    if (!port) {
      ...
      if (!(port > 0 && port <= 65535)) {
        ...
        document.getElementById('error-port').querySelector('span').innerText = "Invalid port: " + port;
        document.getElementById('error-port').querySelector('span').style.color = 'red';
      } else {
        document.getElementById('error-port').querySelector('span').innerText = '';
      }
    }    

    if (!username) {
      errors.push("Value of username is required.");
      var errorUsername = document.getElementById('error-username').querySelector('span');
      errorUsername.innerText = "Value of username is required.";
      errorUsername.style.color = 'red';
    } else {
      document.getElementById('error-username').querySelector('span').innerText = '';
    }

    if (!password) {
      errors.push("Password is required.");
      var errorPassword = document.getElementById('error-password').querySelector('span');
      errorPassword.innerText = "Password is required.";
      errorPassword.style.color = 'red';
    } else {
      document.getElementById('error-password').querySelector('span').innerText = '';
    }
